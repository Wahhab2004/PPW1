...
<body id="top">
  ...
  <div class="topbar">
    <div class="container">
      ...
      <address class="topbar-item">
        ...
        <span class="span">
          Restaurant Ht, Jl Ganesha 7A Bandung, Indonesia
        </span>
      </address>
      ...
      <a href="mailto:booking@restaurant.com" class="topbar-item link">
        ...
        <span class="span">putriyasmin@restaurant.id
        </span>
      </a>
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="./assets/images/logo-1.svg" width="160" height="50" alt="Grilli - Home">
      </a>
      ...
      <nav class="navbar" data-navbar>
        ...
        <div class="text-center">
          ...
          <a href="mailto:booking@grilli.com" class="body-4 sidebar-link">putriyasmin@restaurant.book.id</a>
      ...
      <section class="section service bg-black-10 text-center" aria-label="service">
        <div class="container">
          ...
          <p class="section-text">
            "Experience the Pinnacle of Taste with Our Exquisite Culinary Creations, Meticulously Crafted for the Discerning Palate"
          </p>
      ...
      <section class="section testi text-center has-bg-image"
        ...
        <div class="container">
          ...
          <p class="headline-2 testi-text">
            Very surprised by the service provided, friendly and smiles are very easy to get here,
            and the most important thing is that the taste served is so beautiful and on the tongue.
          </p>
          ...
          <div class="profile">
            <img src="./assets/images/testi.png"  loading="lazy" alt="Wahhab Awaludin"
              class="img  ">

            <p class="label-2 profile-name">Wahhab Awaludin</p>
          </div>
          ...
          <div class="form reservation-form bg-black-10">
            ...
            <form action="" class="form-left">
              ...
              <p class="form-text text-center">
                Booking request <a href="tel:+62123123456" class="link">+62-123-123456</a>
  ...
  <footer class="footer section has-bg-image text-center" id="footer"
    ...
    <div class="container">
      ...
      <div class="footer-top grid-list">
        ...
        <div class="footer-brand has-before has-after">
          ...
          <a href="#" class="logo">
            <img src="./assets/images/logo-1.svg" width="160" height="50" loading="lazy" alt="grilli home">
          </a>
          ...
          <a href="mailto:putriyasmin@restaurant.book.id" class="body-4 contact-link">putriyasmin@restaurant.book.id</a>

          <a href="tel:+88123123456" class="body-4 contact-link">Booking Request : +62-123-123456</a>
      ...
      <div class="footer-bottom">
        ...
        <p class="copyright">
          &copy; 2024 Putjas. All Rights Reserved
        </p>
